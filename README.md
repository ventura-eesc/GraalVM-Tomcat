...
## Intrduction
  ...
  In the scope of the [EU-FOSSSA-2 Project](https://joinup.ec.europa.eu/collection/eu-fossa-2) [hackathon](https://eufossahackathon.bemyapp.com/), there is a list of topics [one of the task](EU FOSSA May 2019 Tomcat con](con https://cwiki.apache.org/confluence/display/TOMCAT/EU+FOSSA+May+2019). Here we will discuss the *GraalVM native-image tool compatibility*
